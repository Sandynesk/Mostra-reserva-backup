        ...
        <div class="container-fluid my-5 px-0"> 
          ...
          <svg class="bi mt-4 mb-3 styled-svg" width="100" height="100"></svg>
            ...
            <p class="col-lg-8 mx-auto fs-5 text-muted">
              O Código de Defesa do Consumidor estabelece que produtos e serviços devem oferecer informação adequada, com especificação correta de quantidade, característicassgit, composição, qualidade, tributos incidentes e preço, bem como sobre os riscos que apresentem.
            </p>
